...
export const mockAdminAuditLogs: AdminAuditLog[] = [
  ...
  },
  {
    ...
    description: 'Sponsor reward track queued for manual eligibility review.',
    severity: 'warning',
...
export const mockSuspiciousUserSignals: SuspiciousUserSignal[] = [
  ...
  },
  {
    ...
    description: 'Email metadata should be reviewed before reward approval if this player enters a paid tier.',
    severity: 'low',
    status: 'watch',
  ...
  },
  {
    id: 'signal-you-clean',
    userId: 'user-you',
    label: 'Manual reward review pending',
    description: 'No integrity block is present, but reward contact details still need manual confirmation.',
    severity: 'low',
    status: 'watch',
